...
export function ProductCard({
  ...
  return (
    <Link
      ...
      className="group flex flex-col overflow-hidden rounded-ui border border-line bg-panel transition-colors hover:border-line-strong"
    >
      <div className="relative aspect-square w-full overflow-hidden bg-paper-2">
        ...
        {outOfStock && (
          <span className="absolute left-2 top-2 rounded-ui bg-ink px-2 py-1 font-mono text-[10px] uppercase tracking-wider text-paper">
            Out of stock
          </span>
        )}
      </div>
